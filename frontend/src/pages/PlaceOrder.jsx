      ...
      <div className='mt-8'>
        ...
        <div className='mt-12'>
          ...
          <div className='flex gap-3 flex-col lg:flex-row'>
            ...
            <div onClick={() => setMethod('razorpay')} className='flex items-cemter gap-3 border p-2 px-3 cursor-pointer'>
              <p className={`min-w-3.5 h-3 border rounded-full ${method === 'razorpay' ? 'bg-green-400' : ''}`}></p>
              <img className='h-5 mx-4 ' src={assets.razorpay_logo} alt="" />
            </div>
            <div onClick={() => setMethod('cod')} className='flex items-cemter gap-3 border p-2 px-3 cursor-pointer'>
